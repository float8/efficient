...
func (d *Date) Scan(src interface{}) error {
	...
	d.Time, _ = time.ParseInLocation("2006-01-02", string(v), time.Local)
	return nil
}
...
func (n *NullDate) Scan(src interface{}) error {
	...
	n.Date, _ = time.ParseInLocation("2006-01-02", string(v), time.Local)
	return nil
}
...
func (t *Time) Scan(src interface{}) error {
	...
	t.Time, _ = time.ParseInLocation("2006-01-02 15:04:05", string(v), time.Local)
	return nil
}
...
func (n *NullTime) Scan(src interface{}) error {
	...
	n.Time, _ = time.ParseInLocation("2006-01-02 15:04:05", string(v), time.Local)
	return nil
}
